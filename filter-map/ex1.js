...
les personnages du côté lumineux (pour ceux qui auraient passé les 40 dernières années 
dans une caverne en Lozère !)
...
function getJedisNames(characters) {
  const jedisList = characters.filter(function(character) {
